...
void cpu_init(void)
{
	...
	// 1 - PB0 (PCINT0/TPIDATA/OC0A/ADC0/AIN0)				INPUT, SOUND SERIAL DATA
	// 2 - GND												
	// 3 - PB1 (PCINT1/TPICLK/CLKI/ICP0/OC0B/ADC1/AIN1)		OUTPUT, SPEAKER
	// 4 - PB2 (T0/CLKO/PCINT2/INT0/ADC2)					INPUT, SOUND SERIAL CLOCK
	// 5 - VCC
	...
	DDRB = 0b00000010;
	PORTB = 0b00000000; // turn off output transistor
